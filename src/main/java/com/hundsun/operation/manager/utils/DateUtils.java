...
/**
 * 这个日期工具类还有个bug，就是如果日期太大（如2300-05-14）或太小的话，自动匹配日期格式的核心算法（getAccurateDate）还是有问题，
 *	目前这个版本支持的范围，大概是：【加100年——当前时间——减100年】
 * @author liuyang20270
 *
 */
public class DateUtils {
    ...
    public static Date LongToDate(long runTime) {
